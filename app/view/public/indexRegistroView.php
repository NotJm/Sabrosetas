...
<div class="flex flex-col lg:flex-row h-screen">
  ...
  <div class="w-full lg:w-1/2 bg-brown-cream-v2 flex flex-col justify-center items-center overflow-y-auto">
    <h1 class="text-2xl font-bold mb-4 text-white-cream">¡Regístrate, PastiUsuario!</h1>
    <div id="formContainer">
      <form id="registroUsuario" action="?C=UserController&M=__add"
        method="post" class="w-full sm:max-w-md registro-form active" autocomplete="off" enctype="multipart/form-data">
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-4">
          <!-- Campo de Nombre de Usuario -->
          <div>
            <label for="username" class="block mb-2 text-sm font-bold text-white-cream">Nombre de Usuario:</label>
            <input type="text" id="username" name="username" class="w-full px-4 py-2 rounded " required
              minlength="5" pattern="^[A-Za-z]+$">
          </div>
          <!-- Campo de Contraseña -->
          <div>
            <label for="password" class="block mb-2 text-sm font-bold text-white-cream">Contraseña:</label>
            <input type="password" id="password" name="password" class="w-full px-4 py-2 rounded "
          ...
          <div>
            ...
            <input type="password" id="cpassword" name="cpassword" class="w-full px-4 py-2 rounded ">
            <div id="validate"></div>
          </div>
          <!-- Campo de Nombre -->
          <div>
            <label for="name" class="block mb-2 text-sm font-bold text-white-cream">Nombre:</label>
            <input type="text" id="name" name="name" class="w-full px-4 py-2 rounded " minlength="4"
              pattern="[A-Z-a-z]* " required>
          </div>
          <!-- Campo de Apellido Paterno -->
          <div>
            <label for="apaterno" class="block mb-2 text-sm font-bold text-white-cream">Apellido Paterno:</label>
            <input type="text" id="apaterno" name="apaterno" class="w-full px-4 py-2 rounded "
          ...
          <div>
            ...
            <input type="text" id="amaterno" name="amaterno" class="w-full px-4 py-2 rounded "
              minlength="4" required pattern="[A-Z-a-z]* ">
          </div>
          <!-- Campo de Email -->
          <div>
          ...
          <div>
            ...
            <input type="text" id="telefono" name="telefono" class="w-full px-4 py-2 rounded " required
              minlength="10" maxlength="10" pattern="[0-9]*">
          </div>
          <!-- Campo de Colonia -->
          <div>
            <label for="colonia" class="block mb-2 text-sm font-bold text-white-cream">Colonia:</label>
            <input type="text" id="colonia" name="colonia" class="w-full px-4 py-2 rounded "
          ...
          <div>
            ...
            <input type="text" id="municipio" name="municipio" class="w-full px-4 py-2 rounded "
              minlength="5" required pattern="[A-Z-a-z]* ">
          </div>
          <!-- Campo de Localidad -->
          <div>
            <label for="localidad" class="block mb-2 text-sm font-bold text-white-cream">Localidad:</label>
            <input type="text" id="localidad" name="localidad" class="w-full px-4 py-2 rounded "
              minlength="5" required pattern="[A-Z-a-z]* ">
          </div>
          <!-- Campo de Calle -->
          <div>
            <label for="calle" class="block mb-2 text-sm font-bold text-white-cream">Calle:</label>
            <input type="text" id="calle" name="calle" class="w-full px-4 py-2 rounded " minlength="5"
          ...
          <div>
            ...
            <input type="text" id="ncasa" name="ncasa" class="w-full px-4 py-2 rounded " minlength="1"
          ...
          <div>
            ...
            <input type="text" id="codigopostal" name="codigopostal" class="w-full px-4 py-2 rounded "
        ...
        <div class="relative">
          ...
          <input type="file" id="avatar" name="avatar" accept="image/*"
            class="w-full py-2 appearance-none bg-transparent  border rounded-lg px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
            required>
...
<script src="app/view/public/js/registro.js" defer></script>